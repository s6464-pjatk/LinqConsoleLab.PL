...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie()
    {
        var method = DaneUczelni.Zapisy
            .FirstOrDefault(z => z.CzyAktywny.Equals(false));
        return (method is not null) ? ["Tak"] : ["Nie"];
    }
    ...
    public IEnumerable<string> Zadanie06_CzyWszyscyProwadzacyMajaKatedre()
    {
        var method = DaneUczelni.Prowadzacy
            .FirstOrDefault(p => !string.IsNullOrEmpty(p.Katedra));
        return (method is not null) ? ["Tak"] : ["Nie"];
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        var query = from z in DaneUczelni.Zapisy
                    ...
                    select $"{g.Key},{g.Average(z => z.OcenaKoncowa.Value):F2}";
        return query;
    }
    ...
    public IEnumerable<string> Zadanie15_ProwadzacyILiczbaPrzedmiotow()
    {
        var query = from pr in DaneUczelni.Prowadzacy
                    join p in DaneUczelni.Przedmioty on pr.Id equals p.ProwadzacyId into joined
                    from sub in joined.DefaultIfEmpty()
                    group sub by new { pr.Imie, pr.Nazwisko } into g
                    select $"{g.Key.Imie},{g.Key.Nazwisko},{g.Count(p => p != null)}";
        return query;
    }
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        var query = from z in DaneUczelni.Zapisy
                    ...
                    select $"{g.Key.Imie},{g.Key.Nazwisko},{g.Max(z => z.OcenaKoncowa.Value):F1}";
        return query;
    }
